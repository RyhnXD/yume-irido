let fs = require('fs') 
 ...
         externalAdReply: { 
                 sourceUrl: 'https://wa.me/62895627514070?text=bang+kamu+ganteng+:v', 
             title: 'ʏᴜᴋɪɴᴏ-ᴍᴅ', 
             body: '', 
 ...
        await this.setBio(`⏲️ ʀᴜɴᴛɪᴍᴇ: ${uptime} | 🛰 ᴍᴏᴅᴇ: ${global.opts['self'] ? 'Private' : setting.groupOnly ? 'Only Group' : 'Public'} |💌 ᴍᴀᴅᴇ ʙʏ ʀᴀʏ`).catch(_ => _)  
