 ...
 *Powered By @${'62895627514070'.split('@')[0]}*`
 ...
       const sections = [
                              {
                                "rows": [{
                                         "title": "📊 › Status ",
                                         "description": "Status カ LUMINOUS-MD",
                                         "rowId": ".botstat"
                                    }, {
                                         "title": "⚡› Speed ",
                                         "description": "Menampilkan Kecepatan Respon カ LUMIOUS-MD",
                                         "rowId": ".ping"
                                    }, {
                                         "title": "🗒️› Info ",
                                         "description": "Menampilkan Info カ LUMINOUS-MD",
                                         "rowId": ".info"
                                    }, {
                                         "title": "🎐 › Developer Bot ",
 ...
           ] 
    const listMessage = {
      text: `Hai Kak ${name} Pilih Menu Dibawah Ini`.trim(),
